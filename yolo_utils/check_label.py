"""
How to run:
python3 check_label.py -i data_in

This code read all the images and annotations from a folder and then show them.
It is done in order to check if all images have their labels correctly, a way to visualize them.
You can save a video with the parameter "-s"
