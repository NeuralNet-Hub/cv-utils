...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 18 15:22:32 2023
...
class CocoDatasetHandler:
    ...
    def save_labelme(self, file_names, dirpath, save_json_only=False):
        ...
        print(f'Images saved in path \'{dirpath}\'')

parser = argparse.ArgumentParser()
parser.add_argument('--input-images', type=str, help='path with images')
parser.add_argument('--output-folder', type=str, default='output', help='output path where images will be saved')
parser.add_argument('--annotations', type=str, default='', help='path with annotations.json')
opt, unknown = parser.parse_known_args()

ds = CocoDatasetHandler(opt.annotations, opt.input_images)
ds.coco2labelme()
ds.save_labelme(ds.labelme.keys(), opt.output_folder)